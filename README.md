...
Config.xml:
id=com.onradiochile.streaming (IOS)
id=com.onradio.streaming (Android)

Plugins:
gulp --cordova 'plugin add cordova-plugin-media --save' (IOS)
gulp --cordova 'plugin add https://github.com/AlexisCaffa/cordova-plugin-mediaac.git --save' (Android)
Note: Do not use both

## Passphrase and alias for Android keystore:
Alias: onradio
Pass: onradioapp

## Email and pass to Appstore:
Email: pvega.radios@gmail.com
Password: Onradiochile2017
